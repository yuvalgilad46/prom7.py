...
# --- Pin Class ---
class Pin(RigidBody):
    def __init__(self, obj_id, pos, vel, quat, ang_vel, radius, height, mass, radius_bottom, fallen=False):
    ...
    def _calculate_inertia(self):
        ...
        if self.mass > 0 and self.radius > 0 and self.height > 0:
            ...
            Ixy_geometric = 0.020865
            Iz_geometric = 0.002680
    ...
    def is_fallen(self):
        if abs(self.pos[2] - 0.12683664) > 0.01:
            self.fallen = True


# --- Simulation Parameters ---
DT = 0.01
NUM_FRAMES = 250 # Increased frames
